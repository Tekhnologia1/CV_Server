        ...
        <div className="wrapper d-flex flex-column min-vh-100 bg-light">
            ...
            <Box className="body flex-grow-1" pt={[5, 10]}>
                ...
                {(role === 'Student') && (
                    ...
                    <Box bg={'#DEFFFD'} p={5} >
                        <Heading textAlign="start" mb={5} color={'black'} fontSize={title_size2} px={['30px', '30px', '50px']}>
                            Demo Test Result
                        </Heading>
                        <Flex direction="row" align="center" justify="center" py={[8, 4]} px={[6, 10, 15]} gap={['40px', '40px', '70px']}>
                            <Image
                                src={TestResult1}
                                alt="Card Image"
                                style={{ width: '100%', height: 'auto', maxWidth: '800px' }} // Increased maxWidth
                                mb={[4, 6]} // Responsive margin-bottom for the image
                            />
                            {/* <Spacer width={['2px', '3px']} />  */}
                            {/* Optional: adds space between images */}
                            <Image
                                src={TestResult2}
                                alt="Card Image"
                                style={{ width: '100%', height: 'auto', maxWidth: '615px' }} // Increased maxWidth
                                mb={[4, 6]} // Responsive margin-bottom for the image
                            />
                        </Flex>
                    </Box>
